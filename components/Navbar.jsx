...
<nav className="bg-darkBlue border-b border-purple-400">
        ...
        <div className="relative flex items-center justify-between h-20">
          ...
          <div className="hidden md:block md:ml-6">
            <div className="flex items-center">
              ...
              >
                <FaGoogle className="mr-2 text-white fa-brands fa-google"></FaGoogle>
          ...
          >
            ...
            <div className="relative ml-3">
              ...
              <div
                id="user-menu"
                className={`${!isProfileMenuOpen ? 'hidden' : ' absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none'}`}
                role="menu"
      ...
      <div className={isMobileMenuOpen ? '' : 'hidden'} id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <Link
            ...
            {!session && (
          <button
            className="flex items-center px-3 py-2 my-5 text-white bg-gray-700 rounded-md hover:bg-gray-900 hover:text-white"
          >
            <FaGoogle className="mr-2 fa-brands fa-google"></FaGoogle>
            <span>Login or Register</span>
          </button>
